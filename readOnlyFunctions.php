...
?>
	<main class="calendar-contain">
		<section class="title-bar">
			...
			<div class="title-bar__year"> Welcome Guest </div>
		...
		<section class="title-bar">
			...
			<!-- adding the direct for signing out of account -->
			<div class="title-bar__month">
				<a href="register.php" class="btn btn-warning">Create an Account</a>
			</div>
			<div class="title-bar__year">
				<a href="login.php" class="btn btn-danger ml-3">Login to your Account</a>
			</div>
